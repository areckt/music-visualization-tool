...
// Everything is defined in seconds; it is sample-rate agnostic
export default class Section {
  ...
  subtract(otherSection) {
    ...
    assert(
      ...
      `Won't subtract, subtraction yields ${this.amountOfSectionsAfterSubtract(
        otherSection
      )} sections [${this.start}, ${this.end}] - [${otherSection.start}, ${
        otherSection.end
      }]`
    )
